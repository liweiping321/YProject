	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (urlBean == null) {
				...
				response.getWriter()
						.write(new HttpResponseMsg<String>(ResponseStatus.FAIL, "请求路径不存在：" + target).toJsonString());
			} else {
				...
				if (!StringUtil.isEmpty(param)) {
					...
					response.getWriter()
							.write(new HttpResponseMsg<String>(ResponseStatus.FAIL, "请求参数为空!").toJsonString());
				}
