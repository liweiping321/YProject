...
public class WebServer {
	...
	public void startHttp() throws Exception {
		...
		threadPool.setMinThreads(LogicConfig.webMinThreads);
		threadPool.setMaxThreads(LogicConfig.webMaxThreads);
		server = new Server(threadPool);
		ServerConnector http = new ServerConnector(server);
		http.setPort(LogicConfig.webPort);
		http.setIdleTimeout(LogicConfig.webIdleTimeOut);
		...
		LogUtils.info("Web socket is starting : " + LogicConfig.webPort);
	}
